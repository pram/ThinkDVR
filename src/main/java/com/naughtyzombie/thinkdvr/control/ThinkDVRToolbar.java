...
public class ThinkDVRToolbar extends HBox {
    private String defaultTitle = "ThinkDVR Toolbar";
    ...
    public ThinkDVRToolbar() {
        getStyleClass().addAll("tool-bar","thinkdvr-tool-bar");
